#
#  Be sure to run `pod spec lint prengine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/shenruisi/prengine"
  ...
  s.author             = { "shen yin" => "tigris.shin@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
